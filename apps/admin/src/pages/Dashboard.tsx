            ...
            <div className="mt-2 flex items-center">
              {stat.status === 'increase' ? (
                ...
                <span className="text-red-600 text-sm flex items-center">
                  <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <title>하락 화살표</title>
                    <path fillRule="evenodd" d="M12 13a1 1 0 110 2H7a1 1 0 01-1-1v-5a1 1 0 112 0v2.586l4.293-4.293a1 1 0 011.414 0L16 9.586 20.293 5.293a1 1 0 111.414 1.414l-5 5a1 1 0 01-1.414 0L12 8.414l-3.293 3.293A1 1 0 018 12H5.414L6.707 13.293A1 1 0 0112 13z" clipRule="evenodd" />
                  </svg>
                  {stat.change}
                </span>
              ) : (
